//
//  LoadStoryboardFriendsViewController.m
//  SendABird
//
...
#import "LoadStoryboardFriendsViewController.h"

@interface LoadStoryboardFriendsViewController ()

@end

@implementation LoadStoryboardFriendsViewController{
...
- (void)viewDidLoad {
    ...
    aStoryBoard = [UIStoryboard storyboardWithName:@"FriendsStoryboard" bundle:nil];
